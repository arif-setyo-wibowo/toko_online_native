					...
					<ul class="header-btns">
						...
						if(isset($_SESSION['customer_status'])){
							...
							<li class="header-account dropdown default-dropdown">
								...
								<a href="daftar.php" class="text-uppercase primary-btn"style="background-color:green">Daftar</a> 
							</li>
							<?php
						}
						?>
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<div class="category-nav show-on-click">
					<span class="category-header"style="background-color:green">Kategori Produk <i class="fa fa-list"></i></span>
