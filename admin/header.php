...
<head>
  ...
  <title>Dashboard Admin - Fuel Terminal XYZ</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>FT</b>XYZ </span>
        <span class="logo-lg"><b>FT</b>XYZ</span>
      </a>
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                if($profil['admin_foto'] == ""){ 
                  ?>
                  <img src="../gambar/Logo.jpg" class="user-image">
                <?php }else{ ?>
